...
from diffusha.diffusion.chi_action_chunking import ConditionalUnet1D
...
class DiffusionModel:
    def __init__(
        ...
        #elf.model = ConditionalModel(num_diffusion_steps, input_size=input_size) # NOTE: MLP version

        global_cond_dim = self.obs_feature_dim * self.n_obs_steps

        self.model = ConditionalUnet1D(
            input_dim=input_size, local_cond_dim=None, global_cond_dim=global_cond_dim 
            )
